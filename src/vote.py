...
fold = 5
out_file = os.path.join(root_dir, 'vote_n2c2_retrieval.txt')
gold_file = os.path.join('/disk2/xy_disk2/thesis/STS/LAP/data/2019n2c2/', 'test_data/test_kg.txt')
filelist = ['n2c2sts_biobert_entityattention_retrieve_01_1/test_result.txt', 'n2c2sts_biobert_entityattention_retrieve_01_2/test_result.txt', 'n2c2sts_biobert_entityattention_retrieve_01_3/test_result.txt', 'n2c2sts_biobert_entityattention_retrieve_01_4/test_result.txt', 'n2c2sts_biobert_entityattention_retrieve_01_5/test_result.txt']


# root_dir = '/disk2/xy_disk2/thesis/STS/LAP/src/bert_src/'
# fold = 5
# out_file = os.path.join(root_dir, 'vote_n2c2_retrieval.txt')
# gold_file = os.path.join("/disk2/xy_disk2/thesis/STS/LAP/data/2019n2c2/data_1", 'test_kg.txt')
...
def vote(filelist, out_file):
    ...
    gold_lines = read_lines(gold_file)
...
# model_dir = '/userhome/xy_pro/STS/src/BIOSESS_final/biosess_biobert_entityemb_'
...
# model_dir = '/userhome/xy_pro/STS/src/EBMSASS_new/ebmsass_bert_entityemb_'
